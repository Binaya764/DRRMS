...
import { Box, Button, TextField, Stack, MenuItem, IconButton, Tooltip } from "@mui/material";
...
import { getVictims, createVictim, deleteVictim, getShelters } from "../services/api";
...
export default function Victims() {
  ...
  return (
    <Box sx={{ width: "100%", p: 3 }}>
      ...
      <FormDialog open={open} onClose={handleClose} onSubmit={handleSubmit} title="Add Victim" loading={saving} error={error}>
        ...
        <TextField select label="Assign to Camp (optional)" name="camp_id" value={form.camp_id} onChange={handleChange}>
